...
<div class="container-gallery gallery position-relative py-5" id="weddingGallery">
  <div class="sub-container">
    <div class="sub">
        <!--conovocatoria-->
        <h2 id="convocatoria">Convocatorias</h2>
    </div>
  </div>
  ...
  <div class="container-gallery position-relative py-5">
      <div class="row g-4">
            ...
            <div class="gallery-item">
              <div class="gallery-img">
                <div class="pdf-container">
                    <img src="{{ asset('pdf-images/olimpiadas.jpg') }}" class="img-fluid w-100" alt="Logo UATF" type="application/pdf">
                </div>
                  <div class="hover-style"></div>
                  <div class="search-icon">
                      <a target="_blank" href="{{ asset('pdfs/discapacidades.pdf') }}" data-lightbox="Gallery-1" class="my-auto"><i class="fas fa-plus btn-primary btn-primary-outline-0 p-3"></i></a>
                  </div>
              </div>
              <div class="gallery-overlay bg-light border-secondary border-top-0 p-4" style="border-style: double;">
                  <h6>Wedding on the beach</h6>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
            <div class="gallery-item">
              <div class="gallery-img">
                <embed class="img-fluid w-100" src="{{ asset('pdfs/discapacidades.pdf') }}" type="application/pdf" />
                  <div class="hover-style"></div>
                  <div class="search-icon">
                      <a target="_blank" href="{{ asset('pdfs/discapacidades.pdf') }}" data-lightbox="Gallery-1" class="my-auto"><i class="fas fa-plus btn-primary btn-primary-outline-0 p-3"></i></a>
                  </div>
